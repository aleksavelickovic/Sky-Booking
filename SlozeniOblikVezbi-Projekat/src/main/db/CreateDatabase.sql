...
INSERT INTO korisnici (korisnickoIme, lozinka, email, ime, prezime, datumRodjenja, datumIVremeRegistracije, blokiran, uloga, loyaltyBodovi) VALUES
('pera', 'pera123', 'petar.petrovic@gmail.com', 'Petar', 'Petrović', '1976-06-24', '2023-11-05 01:32:48', false, 'ADMIN', -1),
('marko', 'marko123', 'marko.petrovic@example.com', 'Marko', 'Petrović', '1990-03-15', '2024-12-21 17:34:22', false, 'PUTNIK', -1),
('nikola', 'nikola123', 'nikola.tesla@example.com', 'Nikola', 'Tesla', '1976-01-07', '2024-12-21 23:45:30', false, 'PUTNIK', -1),
('ana.j', 'securepass', 'ana.jovanovic@example.com', 'Ana', 'Jovanović', '1985-07-10', '2024-12-21 18:45:30', false, 'PUTNIK', -1),
('ivan.n', 'mypassword', 'ivan.nikolic@example.com', 'Ivan', 'Nikolić', '2000-01-25', '2024-12-21 19:12:10', false, 'PUTNIK', -1),
('milica.s', 'qwerty123', 'milica.stankovic@example.com', 'Milica', 'Stanković', '1995-11-05', '2024-12-21 20:05:50', false, 'PUTNIK', -1),
('stefan.p', 'abc12345', 'stefan.popovic@example.com', 'Stefan', 'Popović', '1988-09-12', '2024-12-21 21:30:15', false, 'PUTNIK', -1),
('jelena.k', 'jelena2024', 'jelena.kovac@example.com', 'Jelena', 'Kovač', '1993-06-18', '2024-12-21 22:10:05', false, 'PUTNIK', -1),
('dragana.b', 'dragon789', 'dragana.bogdanovic@example.com', 'Dragana', 'Bogdanović', '1992-04-22', '2024-12-22 00:15:40', true, 'PUTNIK', -1),
('aleksandar.v', 'alex123', 'aleksandar.vukovsic@example.com', 'Aleksandar', 'Vuković', '1998-11-30', '2024-12-22 01:30:00', true, 'PUTNIK', -1),
('milos', 'milos123', 'aleksandar.vukovsic@example.com', 'Aleksandar', 'Vuković', '1998-11-30', '2024-12-22 01:30:00', true, 'PUTNIK', -1),
('katarina.m', 'katy2024', 'katarina.milosevic@example.com', 'Katarina', 'Milošević', '1994-08-15', '2024-12-22 02:20:50', false, 'PUTNIK', -1);
...
INSERT INTO letovi (oznaka, polazisteId, odredisteId, avionId, terminPolaska, trajanjeLeta, cena, naAkciji, brojMesta) VALUES
('FL001', 1, 2, 1, '2025-07-15 08:30:00', 600, 40000, TRUE, 32),
('FL002', 2, 3, 2, '2025-07-16 12:00:00', 840, 55000, TRUE, 50),
('FL003', 3, 4, 3, '2025-07-17 05:45:00', 540, 38000, TRUE, 10),
('FL004', 4, 5, 1, '2025-07-18 19:20:00', 420, 30000, FALSE, 32),
('FL005', 5, 6, 2, '2025-07-19 07:10:00', 720, 47000, TRUE, 50),
('FL006', 8, 2, 1, '2025-07-15 08:30:00', 600, 40000, FALSE, 32),
('FL007', 9, 3, 2, '2025-07-16 12:00:00', 840, 55000, FALSE, 50),
('FL008', 10, 4, 3, '2025-07-17 05:45:00', 540, 38000, FALSE, 10),
('FL009', 2, 4, 1, '2025-07-18 19:20:00', 420, 30000, FALSE, 32),
('FL010', 1, 9, 2, '2025-07-19 07:10:00', 720, 47000, FALSE, 50),
('FL011', 1, 2, 1, '2025-07-16 08:30:00', 600, 40000, FALSE, 32),
('FL012', 1, 12, 1, '2025-07-16 08:30:00', 600, 40000, FALSE, 32);
