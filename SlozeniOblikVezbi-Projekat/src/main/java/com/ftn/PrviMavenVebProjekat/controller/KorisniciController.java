...
//			int ivece = i + 1;
			...
			retHTML += "<h1>Korisnik broj: " + (i + 1) + "</h1>" + "<p>Korisnicko ime: " + korisnik.getKorisnickoIme() + "</p>"
					+ "<p>Loznka: " + korisnik.getLozinka() + "</p>" + "<p>Email: " + korisnik.getEmail()
					+ "<p>Ime: " + korisnik.getIme() + "</p>"
					+ "<p>Prezime: " + korisnik.getPrezime() + "</p>"
					+ "<p>Datum Rodjenja: " + korisnik.getDatumRodjenja() + "</p>"
					+ "<p>Datum I Vreme registracije: " + korisnik.getDatumIVremeRegistracije() + "</p>"
					+ "<p>Uloga: " + korisnik.getUloga() + "</p>"
					;
